...
var _container: ActionContainer = get_parent()
...
func play(_context: Dictionary[StringName, Array] = {}, _params: Dictionary = {}) -> bool:
	if !can_play() or \
	ActionCollision.handle_collision(self, _container.get_playing_actions()) == ActionCollision.CollisionType.BLOCK: 
		return false
...
func _play(_context: Dictionary[StringName, Array] = {}, _params: Dictionary = {}) -> void:
	pass
